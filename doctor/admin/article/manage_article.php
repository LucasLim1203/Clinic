...
<div class="container-fluid">
    ...
    <div class="row" id="article">
        <div class="col-6" id="frm-field">
            ...
            <input type="hidden" name="old_image" value="<?php echo isset($row['image']) ? $row['image'] : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <option <?php echo isset($row['category']) && $row['category'] == "Skin" ? "selected": "" ?>>Skin</option>
                    <option <?php echo isset($row['category']) && $row['category'] == "Body" ? "selected": "" ?>>Body</option>                    
                   <option <?php echo isset($row['category']) && $row['category'] == "Face" ? "selected": "" ?>>Face</option>
                    </select>
                </div>
        ...
        <div class="form-group d-flex justify-content-end w-100 form-group">
            <button class="btn-primary btn">Submit Article</button>
