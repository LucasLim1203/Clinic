...
?>
   ...
   <div class="flex">
      ...
      <div class="inputBox">
         ...
         <input type="text" name="flat" value="<?php echo isset($flat) ? $flat : '';?>" placeholder="House number" class="box" maxlength="50" required>
      </div>
      <div class="inputBox">
         <span>Address line 02 :</span>
         <input type="text" name="street" value="<?php echo isset($street) ? $street : '';?>" placeholder="Street name" class="box" maxlength="50" required>
      </div>
      <div class="inputBox">
         <span>City :</span>
         <input type="text" name="city" value="<?php echo isset($city) ? $city : '';?>" placeholder="City" class="box" maxlength="50" required>
      </div>
      <div class="inputBox">
         <span>State :</span>
         <input type="text" name="state" value="<?php echo isset($state) ? $state : '';?>" placeholder="State" class="box" maxlength="50" required>
      </div>
      <div class="inputBox">
         <span>Country :</span>
         <input type="text" name="country" value="<?php echo isset($country) ? $country : '';?>" placeholder="Country" class="box" maxlength="50" required>
      </div>
      <div class="inputBox">
         <span>Postcode :</span>
         <input type="number" min="0" name="pin_code" value="<?php echo isset($pin_code) ? $pin_code : '';?>" placeholder="Postcode" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
      </div>
   </div>
   
   <input type="submit" name="order" class="btn btn-block btn-primary <?= ($grand_total > 1)?'':'disabled'; ?>" value="Order" style="font-size:15px;">
