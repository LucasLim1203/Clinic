...
<body >
  ...
  <section class="category " >
   ...
   <a href="category.php?category=face" class="swiper-slide slide wow fadeInUp">
      <img src="../assets/img/face.png" alt="">
      <h3>Face</h3>
   </a>

   <a href="category.php?category=body" class="swiper-slide slide wow fadeInUp">
      <img src="../assets/img/body.png" alt="">
      <h3>Body</h3>
   </a>

   <a href="category.php?category=skin" class="swiper-slide slide wow fadeInUp">
      <img src="../assets/img/skin.png" alt="">
      <h3>Skin</h3>
   </a>
