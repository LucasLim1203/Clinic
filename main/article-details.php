        ...
        <div class="col-lg-4">
          <div class="sidebar">
            ...
            <div class="sidebar-block">
              ...
              <ul class="categories">
                <li><a href="article_category.php?category=skin">Skin</a></li>
                <li><a href="article_category.php?category=body">Body</a></li>
                <li><a href="article_category.php?category=face">Face</a></li>
              </ul>
            </div>
