    ...
    <div class="container">
      <form class="main-form" method="post">
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="100ms">
          ...
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="200ms">
            <textarea name="ailment" id="ailment" class="form-control" rows="6" placeholder="More Information..."></textarea>
          </div>
        </div>
        ...
        <button type="submit" name="submit" class="btn btn-primary mt-3 wow zoomIn">Submit</button>
      </form>
    </div>
  </div> <!-- .page-section -->
